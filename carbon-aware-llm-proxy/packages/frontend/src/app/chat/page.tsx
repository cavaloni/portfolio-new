            ...
            {messages.length === 0 ? (
              <div className="h-[60vh] flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="text-muted-foreground max-w-md">
                  Ask me anything about carbon-aware AI, and I'll provide answers while minimizing environmental impact.
                </p>
              </div>
            ) : (
      ...
      <footer className="fixed bottom-0 left-0 right-0 border-t bg-background/80 backdrop-blur-sm p-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-2 text-xs text-muted-foreground text-center">
            <p>
              Carbon-aware AI assistant - Powered by renewable energy when available
            </p>
          </div>
        </div>
      </footer>
