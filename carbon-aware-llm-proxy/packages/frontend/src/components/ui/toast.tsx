...
interface ToastFunction {
  ...
  loading: (message: string, options?: Omit<ToastOptions, 'variant'>) => string | number
...
toast.promise = <T,>(
  ...
  promise
    .then((data) => {
      const message = typeof msgs.success === 'function' 
        ? msgs.success(data) 
        : msgs.success
    ...
    .catch((error) => {
      const message = typeof msgs.error === 'function'
        ? msgs.error(error)
        : msgs.error
