...
export function QuadrantJoystickExample() {
  ...
  const handlePositionChange = (newPosition: { x: number; y: number; quadrant?: string }) => {
    ...
    <div className="p-8 space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Drag the knob to select your preference between Efficiency, Trust, Performance, and Simplicity
        </p>
      </div>
...
{`<QuadrantJoystick onChange={handleChange} />`}
            ...
            <div>
              <h4 className="text-sm font-medium mb-2">With Default Position</h4>
              <pre className="text-xs bg-muted p-2 rounded overflow-x-auto">
{`<QuadrantJoystick 
...
{`<QuadrantJoystick disabled />`}
        ...
        <div className="space-y-2">
          ...
          <div className="text-sm space-y-2">
            <p>
              <strong>Import:</strong> Import the component from the quadrant-joystick directory
            </p>
            <p>
              <strong>Props:</strong> Customize with size, defaultPosition, onChange, and more
            </p>
            <p>
              <strong>Styling:</strong> Uses Tailwind CSS and matches the existing design system
            </p>
            <p>
              <strong>Responsive:</strong> Works on both desktop and mobile devices
            </p>
          </div>
        </div>
      </div>
