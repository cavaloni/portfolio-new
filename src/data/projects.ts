...
export const projects: Project[] = [
  {
    ...
    tech: ['Next.js', 'TypeScript', 'Node.js', 'Redis', 'HuggingFace', 'vLLM', 'AWS', 'GCP', 'RunPod', 'Vercel'],
  ...
  },
  {
    ...
    tech: ['React', 'Redux', 'TypeScript', 'Node.js', 'Python', 'MongoDB'],
  ...
  },
  {
    ...
    tech: ['React', 'Redux', 'SCSS', 'AWS', 'Jest'],
    category: 'Web Development',
    image: '/Zulily.png',
  },
  {
  ...
  },
  {
    ...
    tech: ['React', 'TypeScript', 'Python', 'Django', 'MongoDB'],
    category: 'Data Visualization',
    image: '/syndio.png',
  },
  {
